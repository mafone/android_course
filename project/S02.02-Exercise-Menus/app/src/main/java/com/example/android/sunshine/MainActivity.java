...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData() {
        String location = SunshinePreferences.getPreferredWeatherLocation(this); //I din't see that on the previous exercise
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.forecast, menu); //Inflating the menu in the
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(clickedItem == R.id.action_refresh){ //Refresh was clicked?
