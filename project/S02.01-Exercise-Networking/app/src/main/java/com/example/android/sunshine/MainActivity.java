...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        loadWeatherData("Covilhã");
    }

    // TODO (8) Create a method that will get the user's preferred location and execute your new AsyncTask and call it loadWeatherData
    public void loadWeatherData (String preferredLocation){
        new HttpRequest().execute(NetworkUtils.buildUrl(preferredLocation));
    }
    ...
    public class HttpRequest extends AsyncTask<URL, Void, String>{
        ...
        protected String doInBackground(URL... urls) {
            URL singleURL = urls[0];
            String results = null;
            try{
                results = NetworkUtils.getResponseFromHttpUrl(singleURL);
            }catch (IOException e){
                e.printStackTrace();
            }
            return results; //We'll use this result in a textView
        }
