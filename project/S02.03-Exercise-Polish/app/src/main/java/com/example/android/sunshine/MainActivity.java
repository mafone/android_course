...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorMessage = (TextView) findViewById(R.id.errorId);

        // TODO (17) Find the ProgressBar using findViewById
        showHideProgress = findViewById(R.id.showHideProgress);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPreExecute() {
            showHideProgress.setVisibility(View.VISIBLE);
        }
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            showHideProgress.setVisibility(View.INVISIBLE);
