...
public class MainActivity extends AppCompatActivity {
    ...
    TextView mToysListTextView; //Declaring a new TextView
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToysListTextView = (TextView) findViewById(R.id.tv_toy_names); //Assigning my new TextView with the Id declared in the layout without forgetting to cast the its result to TextView
        ...
        for (int i=0; i<toys.length; i++){
            mToysListTextView.append((CharSequence) (toys[i] + "\n\n\n"));
        }
        /*
        for (String toy : toys){
            mToysListTextView.append((CharSequence) (toy + "\n\n\n"));
        }
        */
    }
}