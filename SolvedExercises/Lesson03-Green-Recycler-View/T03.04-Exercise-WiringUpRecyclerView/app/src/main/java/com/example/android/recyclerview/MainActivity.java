...
public class MainActivity extends AppCompatActivity {
    ...
    GreenAdapter mAdapter; //Our adapter
    RecyclerView mNumbersList; //And the recyclerView
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutManager = new LinearLayoutManager(this); //A new layout in the current context
        ...
        mAdapter = new GreenAdapter(NUM_LIST_ITEMS); //Passing the number of items to our new Adapter

        // TODO (9) Set the GreenAdapter you created on mNumbersList
        mNumbersList.setAdapter(mAdapter); //Passing our adapter to the recyclerView
    }
}
