...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    public class NumberViewHolder extends RecyclerView.ViewHolder{
        ...
        public NumberViewHolder(View itemView){ //We'll call use this class inside a View (eg. MainActivity)
            super(itemView);
            listItemNumberView = (TextView) itemView.findViewById(R.id.tv_item_number);
        }

        public void bind (int listIndex){ //For binding each list item vertically (row by row)
            listItemNumberView.setText(String.valueOf(listIndex)); //Converting the integer to String - with an int the result could be different
        }
    }
