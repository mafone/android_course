...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder>{
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext(); //Where am I been called
        int layoutIdForListItem = R.layout.number_list_item; //The view
        LayoutInflater inflater = LayoutInflater.from(context); //Inflating inside the parent

        boolean shouldAttachToParentImmediately = false;
        View view = inflater.inflate(layoutIdForListItem, parent, shouldAttachToParentImmediately); //inflating inside the parent
