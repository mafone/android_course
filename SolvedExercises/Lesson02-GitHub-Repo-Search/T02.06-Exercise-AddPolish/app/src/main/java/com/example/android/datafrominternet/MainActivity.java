...
public class MainActivity extends AppCompatActivity {
    ...
    void showJsonDataView (){
        mSearchResultsTextView.setVisibility(View.VISIBLE); //Show results
        mErrorMessage.setVisibility(View.INVISIBLE); //Hide the error
    }
    // TODO (15) Create a method called showErrorMessage to show the error and hide the data
    void showErrorMessage (){
        mSearchResultsTextView.setVisibility(View.INVISIBLE); //Hide results
        mErrorMessage.setVisibility(View.VISIBLE); //Show the error
    }
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        ...
        protected void onPreExecute() {
            mProgressBarLoading.setVisibility(View.VISIBLE); //Show progress when the loading process is in background
            super.onPreExecute();
        }
        ...
        protected void onPostExecute(String githubSearchResults) {
            ...
            mProgressBarLoading.setVisibility(View.INVISIBLE); //Hide progress when the loading process is finished and executed
    ...
    JSONObject temp = conditions.getJSONObject("temp");
    ...
    String pressure = conditions.getString("pressure");
    String humidity = conditions.get("humidity");
    */
}
