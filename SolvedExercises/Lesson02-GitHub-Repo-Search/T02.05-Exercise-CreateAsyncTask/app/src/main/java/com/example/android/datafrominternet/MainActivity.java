...
public class MainActivity extends AppCompatActivity {
    ...
    public class GithubQueryTask extends AsyncTask<URL, Void, String> {
        @Override
        protected String doInBackground(URL... urls) { //While on the Main/UI thread we have onPreExecute, on Background thread we have doInBackground.
            URL searchURL = urls[0]; //Get the first url since we're passing just one
            ...
            return githubSearchResults; //This string will be used as the input for  onPostExecute after publishProgress
        }

        @Override
        protected void onPostExecute(String s) { //We pass the string to the textView here
            if ((s != null) && !s.equals("")){
